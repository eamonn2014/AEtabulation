...
```{r, }
  ...
  myFun <- function(n = 5000) {
    a1 <- do.call(paste0, replicate(10, sample(LETTERS, n, TRUE), FALSE))
    a2 <- do.call(paste0, replicate(7, sample(LETTERS, n, TRUE), FALSE))
    a3 <- do.call(paste0, replicate(8, sample(LETTERS, n, TRUE), FALSE))
    a4 <- do.call(paste0, replicate(9, sample(LETTERS, n, TRUE), FALSE))
    paste0("SOC.",a1," ",a2," ",a3, " ", a4,sprintf("%04d", sample(9999, n, TRUE)), sample(LETTERS, n, TRUE))
  }
  ...
  myFun2 <- function(n = 1) {
    ...
    a3 <- do.call(paste0, replicate(8, sample(LETTERS, n, TRUE), FALSE))
    a4 <- do.call(paste0, replicate(9, sample(LETTERS, n, TRUE), FALSE))
    paste0("PT.",a1," ",a2," ",a3, " ", a4,sprintf("%04d", sample(9999, n, TRUE)), sample(LETTERS, n, TRUE))
  }
  
 # SOC <- sort(rep(myFun(m), m)) 
